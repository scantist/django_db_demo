...
class Component(models.Model):
    ...
    created = models.DateTimeField(null=False)
    modified = models.DateTimeField(null=False)
    subject_id_fk = models.ForeignKey(Subject, on_delete=models.CASCADE, null=False)
...
class Vulnerability(models.Model):
    ...
    component_id_fk = models.ForeignKey(Component, on_delete=models.CASCADE, null=False)
